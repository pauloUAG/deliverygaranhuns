...
<div class="container ">
    ...
    <div class="col-md-12">
            ...
            <div class="form-group row mb-0" style="margin: 20px 0 20px 0">
                ...
                @else
                    <form method="POST" action="{{ route('estabelecimentoAdmin.pending.judge', ['estabelecimentoId' => $estabelecimento->id, 'estabelecimentoFk' => $estabelecimento->user_id, 'decisao' => 'false']) }}">
                        @csrf
                        <div class="col-md-12" style="padding-left:0">
                            <button type="submit" class="btn btn-secondary botao-form" style="width:100%">
                                Reprovar Cadastro
                        ...
                        <form method="POST" action="{{ route('estabelecimentoAdmin.pending.judge', ['estabelecimentoId' => $estabelecimento->id, 'estabelecimentoFk' => $estabelecimento->user_id, 'decisao' => 'true']) }}">
                        @csrf
                        <div class="col-md-12" style="padding-right:0">
                            <button type="submit" class="btn btn-primary botao-form" style="width:100%">
                                Aprovar Cadastro
